...
//		 test(source, sourceExtension, targetExtension);
		...
		source = "C:/Users/alfred/Desktop/pdf转换/test.png";
		sourceExtension = FileUtil.getExtensionName(source);
		targetExtension = ".pdf";
//		test(source, sourceExtension, targetExtension);

		source = "C:/Users/alfred/Desktop/pdf转换/test.jpg";
		sourceExtension = FileUtil.getExtensionName(source);
		targetExtension = ".pdf";
		// test(source, sourceExtension, targetExtension);
	...
	public static void test(String sourcePath, String sourceExtension, String targetExtension) throws IOException {
		System.out.println("===================================================");
		// 服务WSDL Document的地址
		URL url = new URL("http://192.168.20.137:7894/pdfconvert/webservice/webservicepdfConvert?wsdl");
