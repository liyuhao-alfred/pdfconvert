...
public class WsdlTest3 {
	...
	public static void main(String[] args) throws IOException {
		...
		source = "C:/Users/alfred/Desktop/pdf转换/项目列表.xlsx";
		sourceExtension = FileUtil.getExtensionName(source);
		targetExtension = ".pdf";
		// test(source, sourceExtension, targetExtension);

		source = "C:/Users/alfred/Desktop/pdf转换/项目列表.xls";
		sourceExtension = FileUtil.getExtensionName(source);
		targetExtension = ".pdf";
		// test(source, sourceExtension, targetExtension);
	...
	public static void test(String sourcePath, String sourceExtension, String targetExtension) throws IOException {
		System.out.println("===================================================");
		// 服务WSDL Document的地址
		URL url = new URL("http://192.168.245.136:80/pdfconvert/webservice/webservicepdfConvert?wsdl");
